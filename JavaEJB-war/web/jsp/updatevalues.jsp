        ...
        <form action="update.jsp" method=post>
            ...
            <table cellpadding="2" width="90%" bgcolor="#F6CECE" align="center"
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="sex" value="m" <% if(Static.user.getSex().equals("m"))out.print("checked");   %> >Male
                        <input type="radio" name="sex" value="f" <% if(Static.user.getSex().equals("f"))out.print("checked");   %> >>Female</td>
                </tr>
